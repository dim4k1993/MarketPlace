...
<table>
    <c:forEach var="pidcategory" items="${pidcategorys}"><tr>
        ...
        <td><--</td>
        <td><c:url value="/adminDeletePidCategory/${pidcategory.name}" var = "url"/> <a href="${url}">Удалить /</a></td>
        <td><c:url value="/adminProduct${pidcategory.name}" var = "url"/>  <a href="${url}" >показать продукти</a>  </td>
    </tr></c:forEach>
</table>
</body>
</html>
